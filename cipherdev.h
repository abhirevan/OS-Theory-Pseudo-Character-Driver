...
#define IOCTL_GET_KEY _IOWR(CIPHERDEV_MAGIC_NUMBER, 5, char*)
// Clear cipher
#define IOCTL_CLEAR_CIPHER _IO(CIPHERDEV_MAGIC_NUMBER, 6)
// Read/Write Message
#define IOCTL_SET_MESG _IOR(CIPHERDEV_MAGIC_NUMBER, 7, char*)
